...
//            "com.rainbow.kam.bluetooth.EXTRA_DATA";
    ...
    //UUID 값 초기화
    public final static UUID getMyUuid = UUID.fromString(GattAttributes.Characteristic.HEART_RATE_MEASUREMENT);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (getMyUuid.equals(characteristic.getUuid())) { //내 UUID와 Characteristic의 UUID일치
            ...
            if (data != null && data.length > 0) {
                ...
                if (UUID.fromString(GattAttributes.Characteristic.BATTRY).equals(characteristic.getUuid())) {
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (getMyUuid.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(GattAttributes.Descriptor.CLIENT_CHARACTERISTIC_CONFIG));
